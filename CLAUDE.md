...
- `src/gsuite_mcp/server.py` — FastMCP server exposing 14 tools (refuses to start without `GSUITE_MCP_API_KEY`)
- `tests/` — pytest suite mirroring the module split (132 tests)
...
Last session: 2026-05-17 10:10:44
