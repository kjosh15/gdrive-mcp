...
- `src/gsuite_mcp/server.py` — FastMCP server exposing 12 tools (refuses to start without `GSUITE_MCP_API_KEY`)
- `tests/` — pytest suite mirroring the module split (73 tests)
...
## Session Tracking
Total Claude sessions: 6
Last session: 2026-05-06 11:00:54
